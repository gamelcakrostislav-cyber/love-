...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "plans_header": "<b>📋 Choose a plan</b>\nTap a button below to subscribe — crypto payment, instant activation.\n\n<i>📱 devices · 🔄 sessions · ⚡ requests per minute</i>",
        "tier_trial": "🎁 trial — opportunities up to 2%",
        "tier_all": "✅ all opportunities",
        "price_free": "free",
        "plan_line": "\n🔹 <b>{name}</b> — {price} · 🗓 {days}d\n   {tier}\n   📱 {devices}  ·  🔄 {sessions}  ·  ⚡ {rate}/min",
        "buy_label": "🛒 Buy {name} — {price} {currency}",
        "plans_promo_btn": "🎟 Have a promo code?",
        ...
        "club_invite": "👥 <b>Members chat</b>\nYour subscription unlocks our private group — connect with other subscribers. Tap to join, I'll let you in:\n{link}",
    ...
    "ru": {
        ...
        "club_invite": "👥 <b>Чат для подписчиков</b>\nВаша подписка открывает закрытую группу — общайтесь с другими подписчиками. Нажмите, чтобы войти, я вас впущу:\n{link}",
    ...
    "uk": {
        ...
        "plans_header": "<b>📋 Оберіть тариф</b>\nНатисніть кнопку нижче, щоб оформити — оплата у крипті, активація миттєва.\n\n<i>📱 пристрої · 🔄 сесії · ⚡ запитів за хвилину</i>",
        "tier_trial": "🎁 пробний — можливості до 2%",
        "tier_all": "✅ усі можливості",
        "price_free": "безкоштовно",
        "plan_line": "\n🔹 <b>{name}</b> — {price} · 🗓 {days}д\n   {tier}\n   📱 {devices}  ·  🔄 {sessions}  ·  ⚡ {rate}/хв",
        "buy_label": "🛒 Купити {name} — {price} {currency}",
        "plans_promo_btn": "🎟 Є промокод?",
        ...
        "club_invite": "👥 <b>Чат для підписників</b>\nВаша підписка відкриває закриту групу — спілкуйтеся з іншими підписниками. Натисніть, щоб увійти, я вас впущу:\n{link}",
    ...
    "es": {
        ...
        "plans_header": "<b>📋 Elige un plan</b>\nPulsa un botón abajo para suscribirte — pago en cripto, activación instantánea.\n\n<i>📱 dispositivos · 🔄 sesiones · ⚡ solicitudes por minuto</i>",
        "tier_trial": "🎁 prueba — oportunidades hasta 2%",
        "tier_all": "✅ todas las oportunidades",
        "price_free": "gratis",
        "plan_line": "\n🔹 <b>{name}</b> — {price} · 🗓 {days}d\n   {tier}\n   📱 {devices}  ·  🔄 {sessions}  ·  ⚡ {rate}/min",
        "buy_label": "🛒 Comprar {name} — {price} {currency}",
        "plans_promo_btn": "🎟 ¿Tienes un código?",
        ...
        "club_invite": "👥 <b>Chat de miembros</b>\nTu suscripción desbloquea el grupo privado — conecta con otros suscriptores. Pulsa para entrar, te dejaré pasar:\n{link}",
    ...
    "fr": {
        ...
        "plans_header": "<b>📋 Choisissez un forfait</b>\nAppuyez sur un bouton ci-dessous — paiement en crypto, activation instantanée.\n\n<i>📱 appareils · 🔄 sessions · ⚡ requêtes par minute</i>",
        ...
        "plans_promo_btn": "🎟 Vous avez un code ?",
        ...
        "club_invite": "👥 <b>Chat des membres</b>\nVotre abonnement débloque le groupe privé — échangez avec les autres abonnés. Appuyez pour rejoindre, je vous laisse entrer :\n{link}",
